	...
	function checkAnswer(status){
		...
		if (status === "correct"){
			if (setNumber == 1){
				...
				popUpScreen("<img src='https://media.giphy.com/media/ojhAx9NdqUTK0/giphy.gif'>");
			} else if (setNumber == 3){
				$(".popupDiv").css("background-color","#000000");
				popUpScreen("<img src='https://media.giphy.com/media/aVU3qORvYjL7a/giphy.gif'>");			
			} else if (setNumber == 4){
				$(".popupDiv").css("background-color","#000000");
				popUpScreen("<img src='https://media.giphy.com/media/3If8u5wFsfII0/giphy.gif'>");
			} else if (setNumber == 5){
				$(".popupDiv").css("background-color","#000000");
				popUpScreen("<img src='https://media.giphy.com/media/l0HlH2sxhkuRE70Zi/giphy.gif'>","theEnd");
			}
			...
			if (setNumber == 1){
				...
				$(".popupDiv").css("background-color","#000000");
				popUpScreen("<img src='https://media.giphy.com/media/l3vRfhFD8hJCiP0uQ/giphy.gif'>");
			} else if (setNumber == 5){
				$(".popupDiv").css("background-color","#ffffff");
